...
type Preferences = {
  ...
  equipment: "nothing_yet" | "dumbbells" | "resistance_bands" | "full_gym";
};
...
const recommendedExercises: ExerciseCard[] = [
  { name: "Push-Up", slug: "push-up", difficulty: "beginner" },
  { name: "Dumbbell Goblet Squat", slug: "dumbbell-goblet-squat", difficulty: "intermediate" },
  { name: "Plank", slug: "plank", difficulty: "beginner" },
  { name: "Burpee", slug: "burpee", difficulty: "advanced" },
  { name: "Dumbbell Shoulder Press", slug: "dumbbell-shoulder-press", difficulty: "intermediate" },
  { name: "Mountain Climber", slug: "mountain-climber", difficulty: "beginner" },
];
...
export function HomeContent({ userEmail }: Props) {
  return (
